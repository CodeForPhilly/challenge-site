...
<link rel="stylesheet" href="http://cdn.leafletjs.com/leaflet-0.7/leaflet.css" />
        ...
        <link rel="stylesheet" href="mysite/css/bootstrap-responsive.min.css">
        <link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.10/themes/base/jquery-ui.css" type="text/css" media="all" />
        <link rel="stylesheet" href="mysite/css/main.css">
        <link rel="stylesheet" href="mysite/chosen/chosen.css">
</head>
<body>
<!--[if lt IE 7]>
...
<script src="mysite/chosen/chosen.jquery.min.js" type="text/javascript"></script>  
<script>

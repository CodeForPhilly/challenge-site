...
<head>
	<% base_tag %>
	<title>Code for Philly Challenges</title>
	<meta charset="utf-8">
			...
			<div class="row" ng-app="challengeApp">
				<div class="col-md-6 col-md-offset-3 site">
						...
						<div class="site-footer">
							<p><a href="/">Home</a> | <a href="http://www.codeforphilly.org">Code for Philly</a> | <a href="//github.com/CfABrigadePhiladelphia/challenge-site"><i class="fa fa-github fa-lg"></i>&nbsp;</a></p>
						</div>
